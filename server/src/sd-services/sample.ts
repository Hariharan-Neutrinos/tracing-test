...
export class sample {
    ...
    this.app['post'](
      ...
      async (req, res, next) => {
        ...
        try {
          ...
          await this.sd_8YZYG3hH8eViuvlh(bh, parentSpanInst);
          //appendnew_next_sd_Cs8MekxI1BT9GolV
        } catch (e) {
          return await this.errorHandler(bh, e, 'sd_Cs8MekxI1BT9GolV');
        }
      },
      this.sdService.getMiddlesWaresBySequenceId(
        null,
  ...
  async sd_8YZYG3hH8eViuvlh(bh, parentSpanInst) {
    try {
      bh.web.res.status(200).send('Tracing works!');

      return bh;
    } catch (e) {
      return await this.errorHandler(bh, e, 'sd_8YZYG3hH8eViuvlh');
    }
  }
